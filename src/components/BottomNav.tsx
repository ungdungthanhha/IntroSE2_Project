...
const styles = StyleSheet.create({
  ...
  uploadBtn: { width: 48, height: 32, position: 'relative', alignItems: 'center', justifyContent: 'center' },
  uploadBg: { position: 'absolute', width: '100%', height: '100%', opacity: 0.4, borderRadius: 8 },
  uploadInner: { width: 40, height: 28, backgroundColor: '#fff', borderRadius: 6, alignItems: 'center', justifyContent: 'center', zIndex: 2 }
});
