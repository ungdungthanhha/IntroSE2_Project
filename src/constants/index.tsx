...
export const MOCK_VIDEOS: Video[] = [
  {
    ...
    videoUrl: 'https://res.cloudinary.com/dvmfpcxz8/video/upload/v1767858412/samples/elephants.mp4',
    caption: 'Nature is healing 🌿✨ #nature #peace #vibe', // description -> caption
    likesCount: 12400,
    commentsCount: 856,
    savesCount: 120, // Bổ sung savesCount
    createdAt: Date.now() - 1000000, // Chỉnh createdAt (string) -> timestamp (number)
  },
  {
    id: '2',
    ownerUid: 'user2',
    ...
    videoUrl: 'https://res.cloudinary.com/dvmfpcxz8/video/upload/v1767858410/samples/sea-turtle.mp4',
